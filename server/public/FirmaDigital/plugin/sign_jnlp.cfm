...
<cfset LvarXML_PDF	= "NULL">
<cfset LvarBtnVer		= "0">
<cfset LvarChecksum = "000000">
<cfset LvarTipoMSG	= "XML/PDF">
<cfset LvarLblTit		= "FirmaMensaje">
...
<cfif isdefined("url.TKN1")>
	...
	<cfset LvarTKN3	= getTickcount()>
	<cfset Application._FirmaDigital_.tokens["TK#LvarToken#"].TKN3 = LvarTKN3>
	<cfset Application._FirmaDigital_.tokens["TK#LvarToken#"].TKN_CNT = 1>
<cfelseif isdefined("url.TKN2") and isdefined("url.TKN3")>
	...
	>
		...
		<cfset LvarXML_PDF	= Application._FirmaDigital_.tokens["TK#LvarToken#"].MSGData.XML_PDF>
		<cfif Application._FirmaDigital_.tokens["TK#LvarToken#"].MSGData.btnVer>
			<cfset LvarBtnVer	= "1">
		</cfif>
		<cfset LvarChecksum = hash(fileReadBinary( expandPath( "lib/FirmaDigitalServer.jar" ) ), "MD5")>
		<cfset LvarTipoMSG	= Application._FirmaDigital_.tokens["TK#LvarToken#"].MSGData.tipoMSG>
		<cfset LvarLblTit		= Application._FirmaDigital_.tokens["TK#LvarToken#"].MSGData.lblTitulo>
...
<cfset LvarData = "#LvarToken#%1F#LvarMSG#%1F#URLEncodedFormat(LvarXML_PDF)#%1F#LvarBtnVer#%1F#LvarChecksum#%1F#LvarTipoMSG#%1F#URLEncodedFormat(LvarLblTit)#%1F#BinaryEncode(LvarWS.getBytes(),"HEX")#">
<script>
	...
	function sbSign()
	{
		...
		<cfoutput>
		LvarAjax.open("GET", "https://firmadigitallocal.com:"+GvarPort+"/FirmaDigitalServer?OP=sign&data=#LvarData#", true);
		</cfoutput>
		LvarAjax.send();
	}
...
<cfelse>
	...
	{
		var LvarAjax = new XMLHttpRequest();
		LvarAjax.open("GET", "sign.cfc?Method=initServer&Token=<cfoutput>#LvarToken#</cfoutput>", true);
	...
	function sbFirmaDigitalInit_Response()
	{
		...
		if (LvarOK)
		{
			location.href = "init_installer.cfm?tkn1=<cfoutput>#LvarToken#</cfoutput>&proceso=sign";
		}
